...
from object_table import save_object,get_object_data,load_objects
...
def main(page):
    ...
    def switch_to_main_ui(e):
        ...
        #             object_type.options.append(ft.dropdown.Option(f"Custom{len(saved_objects)-1}",on_click= add_custom_ui))
